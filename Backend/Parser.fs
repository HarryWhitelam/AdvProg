...
module Parser =
    ...
    //<funcall> ::= <final>     | Function(<args>)
    //<args>    ::= <final>     | <final>,<args>    | <final>;<args>
    ...
    //<funcall> ::= <final> | Function(<args>)
    //<args>    ::= <final><args'>
    //<args'>   ::= ,<final><args'> | ;<final><args'> | ∅
    //<final>   ::= Number | Variable | Reserved | (<expr>) | <funcall> | [<args>]
    ...
    let parse (tokens: Token list) =
        ...
        and funcall tokens =
            ...
            | Token.Function _value :: tail ->  match tail with 
                                                | Token.L_Parenth :: tail2->match args tail2 with
        ...
        and args_pr tokens =
            ...
            | Token.SemiColon :: tail -> (final >> args_pr) tail
            | _ -> tokens
        and final tokens =
            match tokens with
